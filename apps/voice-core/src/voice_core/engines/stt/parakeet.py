...
class ParakeetEngine(StreamingStt):
    ...
    def open(
        ...
        *,
        ...
        self.load()
        return _ParakeetSession(self._model, enable_timing=enable_timing)


class _ParakeetSession(StreamingSttSession):
    def __init__(self, model, *, enable_timing: bool = False):
        self._model = model
        self._buf = bytearray()
    ...
    def _decode_timed(self, audio):
        ...
        return text, {
            ...
            "phase": "stt.inference",
            "ms": elapsed_ms,
            "meta": {"engine": "parakeet-tdt-0.6b-v2", "samples": len(audio)},
        }
