...
export const TOOL_META: Record<string, ToolMeta> = {
  ...
  comfy_workflow_list: { group: "Media", returns: "json:workflows[]", icon: "list" },
  comfy_workflow_get: { group: "Media", returns: "json:workflow", icon: "flow" },
  comfy_workflow_run: { group: "Media", returns: "artifact:media", icon: "play" },
